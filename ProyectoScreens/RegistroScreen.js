        ...
        <View style={styles.formContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              navigation.navigate('InicioSesion'); // Regresa al login
            }}
          >
            <Text style={styles.buttonPrimaryText}>Continuar</Text>
          </TouchableOpacity>

          {/* Botón para volver directamente al login */}
          <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  title: { color: '#4CD964', fontSize: 30, fontWeight: 'bold' },
  subtitle: { color: '#4CD964', fontSize: 12, fontWeight: '300', letterSpacing: 1 },
  formContainer: { width: '100%', marginBottom: 20 },
  header: { color: '#FFF', fontSize: 24, fontWeight: 'bold', textAlign: 'center', marginBottom: 8 },
  instructions: { color: '#BDBDBD', fontSize: 16, textAlign: 'center', marginBottom: 20 },
  input: {
  ...
  backButton: {
    backgroundColor: '#4CD964', padding: 12, borderRadius: 8,
    alignItems: 'center', marginTop: 15
  },
  backButtonText: { color: '#FFF', fontSize: 14, fontWeight: '600' },
  termsText: { color: '#8E8E93', fontSize: 12, textAlign: 'center', marginTop: 15 },
